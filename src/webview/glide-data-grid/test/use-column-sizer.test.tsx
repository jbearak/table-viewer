...
import { type GridCell, GridCellKind, type GridColumn, type Rectangle } from "../index.js";
...
import type { CellArray, CustomCell } from "../internal/data-grid/data-grid-types.js";
import { useColumnSizer } from "../data-editor/use-column-sizer.js";
import type { DataEditorProps } from "../data-editor/data-editor.js";
import { vi, type Mock, expect, describe, it, beforeEach, afterEach } from "vitest";
...
const getShortCellsForSelection = vi.fn(
    buildCellsForSelectionGetter((x, y) => `column ${x} row ${y}`)
) as unknown as DataEditorProps["getCellsForSelection"] & Mock;
