...
/** Moved rows band purple, which is neither diff color — see DIFF_MOVED_FALLBACK. */
const COMPARE_MOVED_BG_FALLBACK = `rgba(147, 51, 234, ${COMPARE_BAND_ALPHA})`;
...
export function GridShell({
    ...
    const compare_row_bgs = useMemo(
        () => ({
            ...
            moved: tint_from_color(
                diff_moved_fg, COMPARE_BAND_ALPHA, COMPARE_MOVED_BG_FALLBACK),
        }),
