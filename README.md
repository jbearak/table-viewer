...
<img src="docs/images/app-column-header-menu.png" alt="The Roast column's context menu in Table Viewer, with sorting, filtering, copying, and hiding actions" width="751">
