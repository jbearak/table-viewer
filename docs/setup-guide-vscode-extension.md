...
- Modern `.xlsx` workbooks have an optional edit mode; legacy `.xls` workbooks are read-only. The extension never writes your sorts, filters, widths, hidden columns, or highlights into either format.
