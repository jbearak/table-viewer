...
- Desktop preparation runs Electron's idempotent installer before bundling, retrying transient download failures up to three times. This repairs an install whose binary download was skipped or interrupted; a complete extraction is left untouched.
