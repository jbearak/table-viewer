...
- Desktop preparation runs Electron's idempotent installer before bundling. This repairs an install whose lifecycle scripts were skipped or interrupted; a complete extraction is left untouched.
